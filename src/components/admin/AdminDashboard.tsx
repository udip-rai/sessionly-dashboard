import { FiUsers, FiCalendar, FiDollarSign, FiUserCheck, FiUserX, FiClock } from 'react-icons/fi';
...
export function AdminDashboard() {
  const stats = [
    ...
    { label: 'Total Bookings', value: '12,843', icon: FiCalendar, change: '+18%' },
    { label: 'Revenue (MTD)', value: '$45,233', icon: FiDollarSign, change: '+22%' },
    { label: 'Avg. Session Duration', value: '52 min', icon: FiClock, change: '+3%' },
  ];
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Manage and monitor all platform activities</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
        ...
        <div className="grid grid-cols-3 gap-4">
          <button className="p-4 text-left rounded-lg hover:bg-gray-50 border border-gray-200 transition-colors duration-200">
            ...
            <h3 className="font-medium text-gray-900 mb-1">Review Expert Applications</h3>
            <p className="text-sm text-gray-600">23 applications pending review</p>
          </button>
          <button className="p-4 text-left rounded-lg hover:bg-gray-50 border border-gray-200 transition-colors duration-200">
            <FiCalendar className="w-6 h-6 text-navy mb-2" />
            <h3 className="font-medium text-gray-900 mb-1">View Today's Sessions</h3>
          ...
          <button className="p-4 text-left rounded-lg hover:bg-gray-50 border border-gray-200 transition-colors duration-200">
            ...
            <p className="text-sm text-gray-600">View latest transaction reports</p>
          </button>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">New Expert Application</p>
                <p className="text-sm text-gray-600">John Doe applied as a Software Engineering expert</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Career Development session with Sarah Johnson</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">$150 paid out to Expert ID #1234</p>
              </div>
            </div>
