  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Edit website content and preview changes</p>
      </div>
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-lg ${
              !previewMode ? 'bg-navy text-white' : 'text-gray-600 hover:bg-gray-50'
            }`}
          >
            Edit Mode
          </button>
              ...
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    ...
                    {new Date(section.lastUpdated).toLocaleDateString('en-US', {
                      year: 'numeric',
                      month: 'long',
                      day: 'numeric',
                      hour: '2-digit',
