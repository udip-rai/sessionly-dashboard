  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Manage all platform users and experts</p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          ...
          <h3 className="text-2xl font-semibold text-gray-900">
            {users.filter(u => u.type === 'student' && u.status === 'active').length}
          </h3>
        </div>
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <p className="text-sm text-gray-600 mb-1">Active Experts</p>
          <h3 className="text-2xl font-semibold text-gray-900">
            {users.filter(u => u.type === 'expert' && u.status === 'active').length}
          </h3>
        </div>
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
